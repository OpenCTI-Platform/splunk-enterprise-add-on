...
1. Download latest version of the Splunk App: [TA-opencti-for-splunk-enterprise-1.1.0.tar.gz](https://github.com/OpenCTI-Platform/splunk-enterprise-add-on/releases/download/1.1.0/TA-opencti-for-splunk-enterprise-1.1.0.tar.gz)
